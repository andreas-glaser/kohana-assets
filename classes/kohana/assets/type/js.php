...
class Kohana_Assets_Type_Js extends Kohana_Asset
{
    ...
    {
        return new Kohana_Assets_Type_Js($location, $params, $processor);
    }
    ...
    public function __construct($location, array $params = array(), $processor = NULL)
    {
        ...
        // execute parent
        parent::__construct('js', $location, $params);
    ...
    public function contents($return = FALSE, $refresh = FALSE)
    {
        ...
        // class
        $class = 'Kohana_Assets_Processor_JS_' . $this->_processor;

        if (!class_exists($class))
        {
            throw new Kohana_Exception('JS Processor has not been found');
        }
